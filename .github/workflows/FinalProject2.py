...
class BasicGui:
   ...
   def on_square_click(self, square_id):
       if square_id in [self.squares[loc - 1] for loc in self.mine_locs]:
           print("You hit a mine! Please start again.")
...
#
# Still need to create a flag system and also create a passage from the start screen to the actual game
#
# Full Code: (This one now opens the game with ‘Start’, quits the game with ‘Quit’, counts the adjacent mines, and adds a pop-up window to try again when a mine is clicked)
# import random
# import tkinter as tk
